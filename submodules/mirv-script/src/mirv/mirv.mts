...
export class MirvJS {
	...
	private static _wsAddress: string = `ws://${constants.websocketListenHost}:${constants.websocketListenPort}/${constants.websocketListenPath}`;
	 ...
	 * Initialize MirvJS.
	 *
	 * @param wsAddress - The address to connect to. Default: `${constants.websocketListenHost}:${constants.websocketListenPort}/${constants.websocketListenPath}`
	 *
	 */
